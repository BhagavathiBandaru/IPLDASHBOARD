...
class Home extends Component {
  ...
  getTeamsList = async () => {
    ...
    const updatedData = {
      name: fetchedData.teams.name,
      imageUrl: fetchedData.teams.team_image_url,
      id: fetchedData.teams.id,
    }
    this.setState({teamsData: updatedData, isLoading: false})
  }
  ...
  renderLoader = () => (
    <div testid="loader" className="loader-container">
      <Loader type="Rings" color="#ffffff" height={65} width={65} />
    </div>
  )
  ...
  render() {
    ...
    return (
      <div className="app-container">
        <div className="ipl-container-display-section">
          <div className="header-container">
            <img
              src="https://assets.ccbp.in/frontend/react-js/ipl-logo-img.png"
              alt="ipl logo"
