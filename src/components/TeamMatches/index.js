...
// At work, we use JavaScript for the frontend web dev (obviously),
// and python in the back. By convention, for JS, we use camelCase for
// variable names and object keys,
// whereas python mostly uses snake_case for everything.
